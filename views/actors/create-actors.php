            ...
            <div class="col-md-6">
                <div class="card">
                    <div class="card-header">
                        <h2 class="card-title">Crear nuevo actor</h2>
                    </div>
                    <div class="card-body">
                        <form method="POST" action="?entity=actors&action=store">
                            <div class="mb-3">
                                <label for="name" class="form-label">Nombres</label>
                                <input type="text" class="form-control mb-3" id="name" name="name" required autofocus
                                    placeholder="Ej: Tom, Emma, Robert">
                                <lablel for="surname" class="form-label">Apellidos</label>
                                    <input type="text" class="form-control mb-3" id="surname" name="surname" required
                                        autofocus placeholder="Ej: Hanks, Stone, Downey Jr.">
